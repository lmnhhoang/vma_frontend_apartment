        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            <NavLink to="/listBuilding">
              <CDBSidebarMenuItem icon="building">Building</CDBSidebarMenuItem>
            </NavLink>
            <NavLink to="/listApartment">
              <CDBSidebarMenuItem icon="box">Apartment</CDBSidebarMenuItem>
            </NavLink>
            <NavLink to="/listDweller">
              <CDBSidebarMenuItem icon="universal-access">Dwellers</CDBSidebarMenuItem>
            </NavLink>
            ...
            <NavLink to="/listBill">
              <CDBSidebarMenuItem icon="bookmark">Bill</CDBSidebarMenuItem>
            </NavLink>
            <NavLink to="/listUser">
        ...
        <CDBSidebarFooter style={{ textAlign: 'left' }}>
          {currentUser ? (
              <div style={{ display: 'flex'}}>
                ...
                <NavLink to="/login" onClick={this.logOut} style={{textDecoration: 'none',color: '#ffffff'}}>
